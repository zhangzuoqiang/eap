	...
	public void login(HttpServletRequest request) throws PassportException {
		...
		if (rememberMeEnable) {
			...
			if (StringUtil.isBlank(vcodeInSession)) {
				throw new PassportException("InvalidVcode", "InvalidVcode", null);
			}
			if (!vcodeInSession.equals(vcode)) {
				throw new PassportException("IllegalVcode", "IllegalVcode", null);
			}
		}
		...
		try {
			...
			throw new PassportException("UnknownAccountException", e.getMessage(), e);
		} catch (LockedAccountException e) {
			throw new PassportException("LockedAccountException", e.getMessage(), e);
		} catch (DisabledAccountException e) {
			throw new PassportException("ExcessiveAttemptsException", e.getMessage(), e);
		} catch (ExcessiveAttemptsException e) {
			throw new PassportException("ExcessiveAttemptsException", e.getMessage(), e);
		} catch (ConcurrentAccessException e) {
			throw new PassportException("ConcurrentAccessException", e.getMessage(), e);
		} catch (AccountException e) {
			throw new PassportException("AccountException", e.getMessage(), e);
		} catch (ExpiredCredentialsException e) {
			throw new PassportException("IncorrectCredentialsException", e.getMessage(), e);
		} catch (IncorrectCredentialsException e) {
			throw new PassportException("IncorrectCredentialsException", e.getMessage(), e);
		} catch (CredentialsException e) {
			throw new PassportException("CredentialsException", e.getMessage(), e);
		} catch (UnsupportedTokenException e) {
			throw new PassportException("UnsupportedTokenException", e.getMessage(), e);
		} catch (AuthenticationException e) {
			throw new PassportException("AuthenticationException", e.getMessage(), e);
		} catch (Exception e) {
			throw new PassportException("Exception", e.getMessage(), e);
		}
	}
